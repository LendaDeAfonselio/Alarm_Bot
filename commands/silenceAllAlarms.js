        ...
        if (subcommand !== null) {
            ...
            try {
                if (subcommand === PRIVATE_COMMAND) {
                    ...
                    await interaction.reply(`The flag you have provided: ${flag} is invalid. Try \`/silenceAllAlarms private\` to silent all of your private alarms or \`/silenceAllAlarms public\` to silent all of your alarms in this server.`);
                }
